...
public class Launcher {
  ...
  public static void main(String[] args) {
    MitarbeiterContainer mitarbeiterContainer = MitarbeiterContainer
        .getInstance();
    ...
    PersistenceStrategyStream<Mitarbeiter> mitarbeiterStrategy = FilestreamFactory
        .createFileSaveStrategy("mitarbeiter");
    ...
    PersistenceStrategyStream<Sprint> sprintStrategy = FilestreamFactory
        .createFileSaveStrategy("sprint");
    sc.setStrategy(sprintStrategy);
    // testMethod();
    enableDemoState();
    Client cl = new Client(mitarbeiterContainer, new Scanner(System.in),
        System.out);
    // The client cl is using the default console input and output, this could
    // be
  ...
  private static void enableDemoState() {
    Loading l1 = new Loading("Martin", "Mueller", "Planer", "Verwaltung",
        "Java11", 3, "HTML5", 3, "KaffeTrinken", 1);
    Loading l2 = new Loading("Anna", "Baum", "Planer", "Verwaltung", "Java8",
        3, "HTML5", 3, "KaffeTrinken", 1);
    String loaded = Loading.sprintCreationString("sprint42", "1.4.2022",
        "30.4.2022", "Java8", 3, "HTML5", 3);
    loaded += Loading.sprintCreationString("sprint45", "1.1.2022",
        "30.8.2022", "Java8", 3, "HTML5", 3);
    loaded += l1.toInputString();
    loaded += l2.toInputString();
    loaded += Loading.saveAndQuit();
    Client cltmp = new Client(MitarbeiterContainer.getInstance(),
        new Scanner(loaded),
